...
export default {
  ...
  methods: {
    fetchAppointments() {
      fetch("https://68068yvk2b.execute-api.ap-northeast-2.amazonaws.com/prod")
        .then(res => res.json())
        .then(data => {
    ...
    updateStatus(appointment, newStatus) {
      ...
      const url = `https://68068yvk2b.execute-api.ap-northeast-2.amazonaws.com/prod/appointments/${appointment.appointmentId}`;
