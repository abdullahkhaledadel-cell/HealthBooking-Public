...
export default {
  ...
  mounted() {
    fetch("https://68068yvk2b.execute-api.ap-northeast-2.amazonaws.com/prod/slots")
      .then(res => res.json())
      .then(data => {
  ...
  methods: {
    submitAppointment() {
      ...
      fetch("https://68068yvk2b.execute-api.ap-northeast-2.amazonaws.com/prod/appointments", {
        method: "POST",
